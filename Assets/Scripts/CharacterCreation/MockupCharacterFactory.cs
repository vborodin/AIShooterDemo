...
namespace AIShooterDemo
{
    ...
    {
        public override ICharacter CreateCharacter(Vector3 position, string characterType, string controllerType, string behaviourTemplate, string team, LevelDataBase levelData)
        {
